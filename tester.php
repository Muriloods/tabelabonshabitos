...
<body>
    ...
    <select name="" id="">
        ...
        <option class="enviar" value="">&#xf00c;</option>
        <option class="enviar" value="">&#xf00d;</option>
    </select>
...
<select class="enviar" name="" id="select">
    <option class="enviar" value="CU">cuzao</option>
    <option selected class="enviar" value="CUZAO">cu</option>
</select>
...
<script>
    $('#select').change(function(event){
        ...
        variavel = event.currentTarget.value;
